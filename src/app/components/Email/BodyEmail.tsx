...
export default function EmailBody({
  ...
  return(
    <>
      <div className="isolate overflow-hidden pt-48 md:pt-3 h-full">
        ...
        />
        <div className="mx-auto max-w-2xl py-24 h-full place-self-center">
          ...
          <div className="text-left">
            ...
            <p className="mt-4 text-2xl leading-8 text-gray-700">

      ...
      */}
      <Transition show={isShowing}>
        <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:flex sm:justify-center sm:px-6 sm:pb-5 lg:px-8 ">
          <div className="z-40 pointer-events-auto flex items-center justify-between gap-x-6 backdrop-blur-sm drop-shadow-lg bg-slate-300/50 px-6 py-2.5 sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
